...
class CLS_guide(object):
    ...
    def add_secret(self,rect,guideId):
        secret = CLS_secret(rect,guideId)
...
G04.add_button('R','bRight.bmp', SCREEN_W -100,SCREEN_W //2 -35,G03.id)

G01.add_txt('我帅吗？', fwork.font32, 372, 386, (0,255,0), (425,450,20,21))
G01.add_secret((425,450,20,21),G04.id)
while True:
